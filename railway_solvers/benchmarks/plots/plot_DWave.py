...
plotD_Wave("DW_default.pdf", title, non_feasible_css, non_feasible_ens, feasible_css, feasible_ens, ground)
...
plotD_Wave("DW_rerouting.pdf", title, non_feasible_css, non_feasible_ens, feasible_css, feasible_ens, ground)
