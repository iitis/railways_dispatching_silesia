...
for i in range(len(schemes)):
    ...
    arr_dep_time = 'N/A'
    check_start = 0
    total_time,times = check_path_time(train,data,schemes[i])
...
total_time_path,_ = check_path_time(train,data,scheme=range(schemes[0][0],schemes[-1][-1]+1),show_warning = False)
