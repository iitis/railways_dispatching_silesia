...
test_pass_not_round = {"94766_Ty_KL": pytest.approx(7.8),"42100_KO_KO(STM)": pytest.approx(0), "42100_KO(STM)_KZ": pytest.approx(1.3)}
...
test_stop_not_round =  {"26103_KO(STM)": pytest.approx(1.7), "421009_KO(STM)": pytest.approx(1.7),
...
test_headway_not_round = {"26103_14006_KZ_KO(STM)": pytest.approx(1.2), "26103_40673_KZ_KO(STM)": pytest.approx(1.2), 
                  "94766_40518_Ty_KL": pytest.approx(2.5), 
                  "40518_94766_Ty_KL": pytest.approx(2.5), "94766_41004_Ty_KL": pytest.approx(3.8), 
