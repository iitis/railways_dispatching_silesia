...
def test_Js():
    ...
    # helper
    assert get_trains_pair9(train_dict) == [
        [42100, 421009],
        [34319, 343199],
        [54101, 541019],
    ]
    # main function
    assert get_jround(train_dict, important_stations) == {
        "KO": [[421009, 42100], [34319, 343199], [54101, 541019]]
    }
...
def test_josingle():
    ...
    assert josingle(train_dict, important_stations, ["KL", "MJ", "Mi"]) == {
        ("KL", "MJ"): [[44717, 44862]],
        ("MJ", "Mi"): [[44717, 44862]],
    }
    ...
    assert trains_same_station_block["KZ"] == [
        [26103, 14006, 40673, 54101, 40675],
        [42100, 40150, 41004, 4500, 40628, 4120],
        [5312, 64350, 73000],
        [34319, 94317],
    ]
    assert trains_same_station_block["KO"] == [
        [94766, 40518, 34319, 343199, 64350, 44862],
        [26103, 40673, 94317],
        [421009, 42100, 54101, 541019, 4500, 40628],
        [5312, 40150, 73000],
        [14006, 40477, 40675],
        [94611, 94113, 44717, 94717],
        [41004, 4120],
    ]
    assert trains_same_station_block["KO(STM)"] == [
        [26103, 14006, 40673, 40675],
        [421009, 42100, 5312, 34319, 40150, 54101, 541019, 4500, 40628, 73000, 4120],
        [41004, 64350],
        [94317],
    ]
    assert trains_same_station_block["CB"] == [
        [26103, 40673, 40675],
        [5312, 40150, 4500, 40628, 73000],
        [94317],
        [64350],
    ]
    assert trains_same_station_block["GLC"] == [
        [26103],
        [5312],
        [40150, 40673, 40628, 40675],
        [4500],
        [73000],
    ]
    assert trains_same_station_block["KL"] == [
        [94766, 40518, 41004, 44862, 4120],
        [14006, 94611, 94113, 40477, 94717],
        [44717],
    ]
